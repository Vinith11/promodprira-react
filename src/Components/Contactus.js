  ...
  return (
    ...
    <div id='contact' className='py-16'>
      ...
      <div className="md:flex-1 bg-gray-200 p-4 md:p-6 rounded-md mt-4 md:mt-0">
        <h2 className="text-2xl font-semibold mb-4">Pramod Priya Seva Samiti</h2>
        <div className="mb-2">
          <label className="block text-sm font-medium text-gray-600">Address</label>
          <p className="text-gray-800">S.O, CTS NO.5310, DR.SPM ROAD, OPP.SHIVAJI GARDEN, Shahapur, Belagavi, Karnataka 590003</p>
        </div>
        <div className="mb-2">
        ...
        <div className="mb-2">
          ...
          <p className="text-gray-800">Mr . Poornabhoda Katti</p>
        </div>
      </div>
    </div>
    </div>
